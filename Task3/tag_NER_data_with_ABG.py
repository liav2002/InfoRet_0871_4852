...
def process_excel_file_with_ABG(file_path, result_dict):
    ...
    df.to_excel(f"./output/tagged_NER_1500_docs_with_ABG/tagged_NER_with_ABG_{group_id}.xlsx", index=False)
...
def main():
    ...
    for file_path in file_paths:
        ...
        with open(f"./output/tagged_NER_1500_docs_with_ABG/result_NER_ABG_{group_id}.json", 'w') as json_file:
