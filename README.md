...
Exercise 1 was mainly a preprocess task.
There is not much content in it except the way the matrices are created, so I will briefly summarize what is being done and I will not go into too much detail. I will just note that his output was used by us to continue the tasks that I will detail later.
You can see Task1/README.md for more details.
...
![Alt Text](Task2/output/K-means/Bert_On_Source_Groups/tsne_A&C.png)
...
![Alt Text](Task2/output/K-means/Bert_On_Source_Groups/tsne_B&C.png)
...
![Alt Text](Task2/output/K-means/D2V_On_Source_Groups/tsne_A&B.png)
...
![Alt Text](Task2/output/K-means/D2V_On_Source_Groups/tsne_A&C.png)
...
![Alt Text](Task2/output/K-means/D2V_On_Source_Groups/tsne_B&C.png)
...
![Alt Text](Task2/output/K-means/TFIDF_On_Lemots_Groups/tsne_A&B.png)
...
![Alt Text](Task2/output/K-means/TFIDF_On_Lemots_Groups/tsne_A&C.png)
...
![Alt Text](Task2/output/K-means/TFIDF_On_Lemots_Groups/tsne_B&C.png)
...
![Alt Text](Task2/output/K-means/TFIDF_On_Words_Groups/tsne_A&B.png)
...
![Alt Text](Task2/output/K-means/TFIDF_On_Words_Groups/tsne_A&C.png)
...
![Alt Text](Task2/output/K-means/TFIDF_On_Words_Groups/tsne_B&C.png)
...
![Alt Text](Task2/output/K-means/W2V_On_Lemots_Groups/tsne_A&B.png)
...
![Alt Text](Task2/output/K-means/W2V_On_Lemots_Groups/tsne_A&C.png)
...
![Alt Text](Task2/output/K-means/W2V_On_Lemots_Groups/tsne_B&C.png)
...
![Alt Text](Task2/output/K-means/W2V_On_Words_Groups/tsne_A&B.png)
...
![Alt Text](Task2/output/K-means/W2V_On_Words_Groups/tsne_A&C.png)
...
![Alt Text](Task2/output/K-means/W2V_On_Words_Groups/tsne_B&C.png)
...
![Alt Text](Task2/output/DBSCAN/Bert_On_Source_Groups/k_distance_graph_BC.png)
...
![Alt Text](Task2/output/DBSCAN/D2V_On_Source_Groups/k_distance_graph_BC.png)
...
![Alt Text](Task2/output/DBSCAN/TFIDF_On_Lemots_Groups/k_distance_graph_BC.png)

**TFIDF On Words matrices**

Let's add to the plot the graph for TFIDF On Words matrices:

![Alt Text](Task2/output/DBSCAN/TFIDF_On_Words_Groups/k_distance_graph_BC.png)
...
![Alt Text](Task2/output/DBSCAN/W2V_On_Lemots_Groups/k_distance_graph_BC.png)

**W2V On Words matrices**

Let's add to the plot the graph for W2V On Words matrices:

![Alt Text](Task2/output/DBSCAN/W2V_On_Words_Groups/k_distance_graph_BC.png)
...
![Alt Text](Task2/output/DBSCAN/Bert_On_Source_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/DBSCAN/Bert_On_Source_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/DBSCAN/Bert_On_Source_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/DBSCAN/D2V_On_Source_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/DBSCAN/D2V_On_Source_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/DBSCAN/D2V_On_Source_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/DBSCAN/TFIDF_On_Lemots_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/DBSCAN/TFIDF_On_Lemots_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/DBSCAN/TFIDF_On_Lemots_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/DBSCAN/TFIDF_On_Words_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/DBSCAN/TFIDF_On_Words_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/DBSCAN/TFIDF_On_Words_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/DBSCAN/W2V_On_Lemots_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/DBSCAN/W2V_On_Lemots_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/DBSCAN/W2V_On_Lemots_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/DBSCAN/W2V_On_Words_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/DBSCAN/W2V_On_Words_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/DBSCAN/W2V_On_Words_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/MixOG/Bert_On_Source_Groups/tsne_A&B.png)
...
![Alt Text](Task2/output/MixOG/Bert_On_Source_Groups/tsne_A&C.png)
...
![Alt Text](Task2/output/MixOG/Bert_On_Source_Groups/tsne_B&C.png)
...
![Alt Text](Task2/output/MixOG/D2V_On_Source_Groups/tsne_A&B.png)
...
![Alt Text](Task2/output/MixOG/D2V_On_Source_Groups/tsne_A&C.png)
...
![Alt Text](Task2/output/MixOG/D2V_On_Source_Groups/tsne_B&C.png)
...
![Alt Text](Task2/output/MixOG/TFIDF_On_Lemots_Groups/tsne_A&B.png)
...
![Alt Text](Task2/output/MixOG/TFIDF_On_Lemots_Groups/tsne_A&C.png)
...
![Alt Text](Task2/output/MixOG/TFIDF_On_Lemots_Groups/tsne_B&C.png)
...
![Alt Text](Task2/output/MixOG/TFIDF_On_Words_Groups/tsne_A&B.png)
...
![Alt Text](Task2/output/MixOG/TFIDF_On_Words_Groups/tsne_A&C.png)
...
![Alt Text](Task2/output/MixOG/TFIDF_On_Words_Groups/tsne_B&C.png)
...
![Alt Text](Task2/output/MixOG/W2V_On_Lemots_Groups/tsne_A&B.png)
...
![Alt Text](Task2/output/MixOG/W2V_On_Lemots_Groups/tsne_A&C.png)
...
![Alt Text](Task2/output/MixOG/W2V_On_Lemots_Groups/tsne_B&C.png)
...
![Alt Text](Task2/output/MixOG/W2V_On_Words_Groups/tsne_A&B.png)
...
![Alt Text](Task2/output/MixOG/W2V_On_Words_Groups/tsne_A&C.png)
...
![Alt Text](Task2/output/MixOG/W2V_On_Words_Groups/tsne_B&C.png)
...
![Alt Text](Task2/output/ANN/Bert_On_Source_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/ANN/Bert_On_Source_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/ANN/Bert_On_Source_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/ANN/D2V_On_Source_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/ANN/D2V_On_Source_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/ANN/D2V_On_Source_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/ANN/TFIDF_On_Lemots_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/ANN/TFIDF_On_Lemots_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/ANN/TFIDF_On_Lemots_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/ANN/TFIDF_On_Words_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/ANN/TFIDF_On_Words_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/ANN/TFIDF_On_Words_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/ANN/W2V_On_Lemots_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/ANN/W2V_On_Lemots_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/ANN/W2V_On_Lemots_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/ANN/W2V_On_Words_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/ANN/W2V_On_Words_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/ANN/W2V_On_Words_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/NB/Bert_On_Source_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/NB/Bert_On_Source_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/NB/Bert_On_Source_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/NB/D2V_On_Source_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/NB/D2V_On_Source_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/NB/D2V_On_Source_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/NB/TFIDF_On_Lemots_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/NB/TFIDF_On_Lemots_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/NB/TFIDF_On_Lemots_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/NB/TFIDF_On_Words_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/NB/TFIDF_On_Words_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/NB/TFIDF_On_Words_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/NB/W2V_On_Lemots_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/NB/W2V_On_Lemots_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/NB/W2V_On_Lemots_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/NB/W2V_On_Words_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/NB/W2V_On_Words_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/LogisticRegression/Bert_On_Source_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/LogisticRegression/Bert_On_Source_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/LogisticRegression/Bert_On_Source_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/LogisticRegression/D2V_On_Source_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/LogisticRegression/D2V_On_Source_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/LogisticRegression/D2V_On_Source_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/LogisticRegression/TFIDF_On_Lemots_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/LogisticRegression/TFIDF_On_Lemots_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/LogisticRegression/TFIDF_On_Lemots_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/LogisticRegression/TFIDF_On_Words_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/LogisticRegression/TFIDF_On_Words_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/LogisticRegression/TFIDF_On_Words_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/LogisticRegression/W2V_On_Lemots_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/LogisticRegression/W2V_On_Lemots_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/LogisticRegression/W2V_On_Lemots_Groups/umap_B&C.png)
...
![Alt Text](Task2/output/LogisticRegression/W2V_On_Words_Groups/umap_A&B.png)
...
![Alt Text](Task2/output/LogisticRegression/W2V_On_Words_Groups/umap_A&C.png)
...
![Alt Text](Task2/output/LogisticRegression/W2V_On_Words_Groups/umap_B&C.png)
